...
func main() {
	...
	//if index > 0 {
	//
	//	fmt.Println(remark[index+6:len(remark)])
	//}
	if strings.Contains(remark, "截") {
		index := strings.Index(remark, "截")
		fmt.Println(index)
		fmt.Println(remark[index+3 : len(remark)])
	}

	return
	fmt.Println("请选择你想要操作的游戏游戏品牌")
