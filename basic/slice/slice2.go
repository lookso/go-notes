...
func main()  {
	...
	testStr:=[]interface{}{"name","jack"}
	fmt.Println(testStr...)
	//切片传参
	nums:=[]int{1,2,3,4,5}


	handleNums:=funcSlice(nums)
	fmt.Println("handleNums:",handleNums) // handle_num: [100 2 3 4 5]
	fmt.Printf("handleNums ptr:%p\n",&handleNums) // handleNums ptr:0xc00000a0a0
	fmt.Println("nums:",nums) // nums: [100 2 3 4 5]
	fmt.Printf("nums ptr:%p\n",&nums) // nums ptr:0xc00000a080
...
// 切片作为参数传递
func funcSlice(data []int) (nums []int) {
	data[0]=100
	nums=data
	return nums
